...
const EditPost = () => {
  ...
  const [originalPost, setOriginalPost] = useState<{text: string, media: Media | null}>({
    text: '',
    media: null
  });
  ...
  const handleUpdate = useCallback(() => {
    if (!postText.trim() && !media) {
      Alert.alert('Error', 'Please write something or add media before updating.');
      return;
    }
      ...
      >
        ...
        <View style={styles.actionBar}>
          ...
          <ActionButton
            ...
            style={[styles.updateButton, isUpdateDisabled && styles.updateButtonDisabled]}
